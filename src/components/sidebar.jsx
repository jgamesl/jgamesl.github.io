          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            ...
            <nav id="colorlib-main-menu">
              <ul>
                ...
                {/* <li><a href="https://twitter.com/jgms" target="_blank" rel="noopener noreferrer"><i className="icon-twitter2" /></a></li> */}
                ...
                {/* <li><a href="https://medium.com/@dhruv.jgamesl" target="_blank" rel="noopener noreferrer"><i className="icon-blogger2"></i></a></li> */}
              </ul>
            </nav>
